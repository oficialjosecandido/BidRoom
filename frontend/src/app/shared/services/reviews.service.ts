...
export interface MyReview {
  ...
  isPlatformReview?: boolean;
  listing?: { _id: string; title: string; slug: string; images?: string[] } | null;
  reviewer?: { _id: string; firstName: string; lastName: string; slug?: string } | null;
  reviewee?: { _id: string; firstName: string; lastName: string; slug?: string } | null;
}
...
export class ReviewsService {
  ...
  getMine(): Observable<{ written: MyReview[]; received: MyReview[] }> {
    return this.http.get<{ written: MyReview[]; received: MyReview[] }>(`${this.apiUrl}/mine`);
  }
