...
export class AddListing implements OnInit, OnDestroy {
  ...
  itemCountries = [
    ...
    { value: 'BG', labelKey: 'addListing.countryBG' },
    { value: 'CY', labelKey: 'addListing.countryCY' },
    { value: 'HR', labelKey: 'addListing.countryHR' },
    { value: 'DK', labelKey: 'addListing.countryDK' },
    { value: 'SK', labelKey: 'addListing.countrySK' },
    { value: 'SI', labelKey: 'addListing.countrySI' },
    { value: 'ES', labelKey: 'addListing.countryES' },
    { value: 'EE', labelKey: 'addListing.countryEE' },
    { value: 'FI', labelKey: 'addListing.countryFI' },
    { value: 'FR', labelKey: 'addListing.countryFR' },
    { value: 'GR', labelKey: 'addListing.countryGR' },
    { value: 'HU', labelKey: 'addListing.countryHU' },
    { value: 'IE', labelKey: 'addListing.countryIE' },
    { value: 'IT', labelKey: 'addListing.countryIT' },
    { value: 'LV', labelKey: 'addListing.countryLV' },
    { value: 'LT', labelKey: 'addListing.countryLT' },
    { value: 'LU', labelKey: 'addListing.countryLU' },
    { value: 'MT', labelKey: 'addListing.countryMT' },
    { value: 'NL', labelKey: 'addListing.countryNL' },
    { value: 'PL', labelKey: 'addListing.countryPL' },
    { value: 'PT', labelKey: 'addListing.countryPT' },
    { value: 'CZ', labelKey: 'addListing.countryCZ' },
    { value: 'RO', labelKey: 'addListing.countryRO' },
    { value: 'SE', labelKey: 'addListing.countrySE' },
  ];
