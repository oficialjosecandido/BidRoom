...
# Bidroom Azure Deployment Script - QA Environment
set -e

# Configuration
ENVIRONMENT="qa"
LOCATION="East US"
RESOURCE_GROUP="rg-bidroom-qa"
SUBSCRIPTION_ID="your-subscription-id"

echo "🚀 Deploying Bidroom QA Environment..."
...
az deployment group create \
    ...
    --name "bidroom-qa-deployment-$(date +%Y%m%d-%H%M%S)" \
    --verbose
...
echo "2. Set up custom domain: qa.bidroom.co"
